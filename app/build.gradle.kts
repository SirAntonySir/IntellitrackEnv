...
android {
    namespace = "com.example.intellitrackenv"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.intellitrackenv"
        minSdk = 33
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.appcompat:appcompat:1.6.1") // Kept the highest version, removed 1.3.1
